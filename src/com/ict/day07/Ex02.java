...
public class Ex02 {
	public static void main(String[] args) {
		...
		su[0] = 100;
		su[1] = 'a';
		// su[2] = 3.14; int 배열이라 double 자료형은 들어가지 못한다.
		su[2] = (int)(3.14);  // 디모션  int로 강제형변환 하여 3만 들어간다.
		su[3] = 100;
		// 배열 크기보다 크면
		//	su[4] = 107;   // 저장할때는 오류가 안 뜨지만 실행하면 오류 발생(run time 오류)
		
		su[2] = 107; // 가장 최근의 값을 기억
