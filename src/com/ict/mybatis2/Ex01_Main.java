...
public class Ex01_Main {
	public static void main(String[] args) {
		...
		case 2:
			...
			vo2.setAge(age2);
			int res2 = Ex01_DAO.getInsert(vo2);
			if(res2 >0) {
		...
		case 3:
			...
			int res3 = Ex01_DAO.getDelete(idx3);
			if(res3 >0) {
			...
			*/	
			...
			vo3.setIdx(idx3);
			int res3 = Ex01_DAO.getDelete(vo3);
			if(res3 >0) {
				List<Ex01_VO> list3 =  Ex01_DAO.getList();
				prn(list3);
			}else {
		...
		case 4:
			...
			vo4.setAge(age4);
			int res4 = Ex01_DAO.getUpdate(vo4);
			if(res4>0) {
	...
	public static void prn(List<Ex01_VO> list) {
		System.out.println("IDX\tI D\tPWD\tUSERNAME\tAGE\tREGDATE");
		for (Ex01_VO k : list) {
