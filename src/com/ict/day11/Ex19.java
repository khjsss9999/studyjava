...
public class Ex19 {
	public static void main(String[] args) {
		// Calendar 클래스
		// new 예약어와 생성자를 사용하지 않고 객체 생성하면서 현재 PC 날짜와 시간 지정
		...
		System.out.println(now.get(Calendar.MONTH)+1 + "월");  		// 0~11 까지 표현이라 +1
	...
	//	System.out.println(now.getTime());
		...
		System.out.println("1970년 1월 1일 00시 00분부터 흐른 초 : \n"+now.getTimeInMillis()+"밀리초");
		...
		System.out.println(diff/(60*60*24*1000)); // (60 * 60* 24 * 1) 로 밀리초를 나눠 주면 일이 됨 
