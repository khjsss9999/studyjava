...
public class Ch_Client extends JFrame implements Runnable{
...
//		contentPane.setLayout(new CardLayout(0, 0));
		...
		img.setIcon(new ImageIcon(Ch_Client.class.getResource("/images/talk.png")));
	...
	private boolean connected() {
		boolean value = true;
		try {
			s = new Socket("192.168.0.41", 7004);
